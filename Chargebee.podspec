...
Pod::Spec.new do |s|
  s.name             = 'Chargebee'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Chargebee.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/cb-prabu/Chargebee'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'cb-prabu' => 'meetprabu88@gmail.com' }
  s.source           = { :git => 'https://github.com/cb-prabu/Chargebee.git', :tag => s.version.to_s }
